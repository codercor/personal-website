  ...
  return (
    <div className='flex justify-between items-center '>
        ...
        <div className="flex items-center gap-[25px] px-[50px] bg-primary h-[80px]">
            ...
            <a href="#02" className="text-bgBlack font-rationale">02.tooling</a>
            <a href="#03" className="text-bgBlack font-rationale">03.experience</a>
            <a href="#04" className="text-bgBlack font-rationale">04.projects</a>
            <a href="#05" className="text-bgBlack font-rationale">05.contact</a>
